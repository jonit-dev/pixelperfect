    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-sm font-semibold mb-1 text-info">{t('i18n.englishOnly.title')}</h3>
          <p className="text-sm text-info/80">{t('i18n.englishOnly.message')}</p>
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            >
              ...
              {t('i18n.englishOnly.switchButton')}
            </button>
          </div>
        </div>
