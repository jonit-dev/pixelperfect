      ...
      <div className="relative max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <article>
                ...
                <div className="max-w-2xl mx-auto bg-gradient-to-br from-surface-light to-surface-light/50 rounded-xl p-8 border border-border">
                  <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold">
                      {data.resolution} {t('templates.scale.specifications')}
                    </h2>
                  </div>
          ...
          {data.benefits && data.benefits.length > 0 && (
            <FadeIn delay={0.5}>
              <section className="py-12 bg-gradient-to-br from-accent/10 to-accent/5 rounded-2xl px-8">
                <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
                  {t('templates.scale.whyUpscale', { resolution: data.resolution })}
                </h2>
          ...
          <div className="py-8">
            <FadeIn>
              <CTASection
                title={t('templates.scale.readyToUpscale', { resolution: data.resolution })}
                description={t('templates.scale.transformImages')}
                ctaText={t('templates.scale.startUpscaling', { resolution: data.resolution })}
                ctaUrl="/?signup=1"
                pageType="scale"
                slug={data.slug}
              />
          ...
          {data.relatedScales && data.relatedScales.length > 0 && (
            <FadeIn delay={0.6}>
              <section className="py-8 border-t border-border">
                <h2 className="text-2xl font-bold mb-6">{t('templates.scale.otherResolutions')}</h2>
          ...
          {data.relatedGuides && data.relatedGuides.length > 0 && (
            <FadeIn delay={0.7}>
              <section className="py-8">
                <h2 className="text-2xl font-bold mb-6">{t('templates.scale.relatedGuides')}</h2>
